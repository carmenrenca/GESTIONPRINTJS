...
var fila2="<tr><td>"+codigo+"</td><td>"+nombre+"</td><td>"+precio+"</td><td>"+cantidad+"</td><td>"+preciototal+"</td><td>";
...
var total="<tr><td>"+"</td><td>"+"</td><td>"+"</td><td>"+'SUBTOTAL €'+"</td><td>"+sumatotal+"</td></tr>";
  ...
  btn.innerHTML=fila;
    ...
    document.getElementById("lineav").appendChild(btn2);
 //limpio los imput 
...
console.log("preciototall "+preciototal);
...
document.getElementById('preciototal').value=sumatotal;
document.getElementById('preciototal2').value=sumatotal;
///IVA
var iva;
iva=sumatotal*0.18;
...
document.getElementById('total2').value=iva+sumatotal;
}
...
//vamos a añadir nuestor articulo a la factura para eso vamos a ir recorriendo la tabla
  ...
  var contenido_f= document.getElementById("contCliente");
var c=0;
var id_facutura= document.getElementById('Nfactura').value;
...
contenido_f.innerHTML +=`
  ...
  <div class="col class="row align-items-start"">
  <p >
    <strong>Fecha :</strong> ${document.getElementById('fecha').value} <br>
    <strong>ID_FACTURA:</strong> ${id_facutura}
    </p>
    <p>DATOS DE LA EMPRESA</p>
  <p align="left">NIF:17000000A <br>
 Calle Torneo <br>
 50000-Sevilla <br>
 Sevilla(España)<br>
 Tel 974372837 | Fax 973947293<br>
 http://paginaejemplo.com<br>
 correoejemplo@gmail.com<br>
  </p>

  </div>
  <div class="col class="row align-items-end"">

 
  <p align="left">
  CLIENTE: <br>
  <strong>${document.getElementById('nombre').value} ${document.getElementById('apellido').value} </strong><br>
  NIF: ${document.getElementById('sele').value} <br>

${document.getElementById('direccion').value} <br>

 Tel: ${document.getElementById('telefono').value}<br>
